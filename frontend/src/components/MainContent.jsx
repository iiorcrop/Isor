          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#064e3b]">{about.title}</h2>
              </div>
              ...
              <div className="space-y-6 text-[#374151] leading-relaxed text-lg">
                {about.content.length > 0 &&
                  (() => {
                    ...
                    const displayText = !isLong || isAboutExpanded ? fullText : fullText.slice(0, 600) + "...";
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-xs uppercase font-bold tracking-widest text-[#6b7280]">{stat.label}</div>
                </motion.div>
              ))}
            </div>
          </div>
              ...
              >
                ...
                {[...announcements, ...announcements].map((ann, index) => (
                  <motion.a
                    key={`${ann._id}-${index}`}
                    href={ann.link}
                    className="px-5 block hover:bg-emerald-50/40 transition-colors group"
                  >

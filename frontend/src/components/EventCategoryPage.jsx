        ...
        const fetchEvents = async () => {
            ...
            try {
                const url = categoryType 
                    ? `${import.meta.env.VITE_API_URL}/events?type=${encodeURIComponent(categoryType)}`
        ...
        <div className="min-h-screen bg-[#fff9f0] py-16 px-6">
            ...
            <div className="max-w-7xl mx-auto mb-16">
                ...
                >
                    ...
                    <div className="bg-[#064e3b] text-white p-8 rounded-3xl shrink-0 text-center space-y-2 shadow-xl border border-[#b47c1c]/20">
                        ...
                        <h3 className="font-serif font-bold text-xl">{events.length} Items</h3>
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-32 space-y-4">
                    ...
                    <p className="text-[#064e3b] font-bold text-sm">Loading {title}...</p>
                </div>
            ) : events.length === 0 ? (
                <div className="text-center py-32 bg-white max-w-2xl mx-auto rounded-[3rem] border border-[#064e3b]/10 shadow-xl p-12 space-y-4">
                    ...
                    <h3 className="text-xl font-serif font-bold text-[#064e3b]">No {title} Found</h3>
                    <p className="text-gray-500 text-xs">Events and gallery photos published under this category will appear here.</p>
                </div>
            ) : (
                    ...
                    {events.map((event, idx) => (
                        ...
                        >
                            <div className="aspect-[4/3] overflow-hidden relative bg-gray-50">
                                ...
                                <div className="absolute top-4 left-4 bg-[#b47c1c] text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase shadow-lg flex items-center gap-1">
                                    <Tag size={12} />
                                    {event.type || 'events'}
                                </div>

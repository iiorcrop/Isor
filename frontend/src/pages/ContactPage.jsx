            ...
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                >
                    ...
                    <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                        Have questions regarding ISOR membership, journal paper submissions, or upcoming events? Get in touch with our administrative office.
                    </p>
                </motion.header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                <h4 className="text-[#064e3b] font-serif font-bold text-lg">Secretariat Address</h4>
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                <h4 className="text-[#064e3b] font-serif font-bold text-lg">Telephone & Fax</h4>
                    ...
                    >
                        ...
                        <p className="text-xs text-gray-500 mb-8">Fill out the form below and our secretariat will get back to you shortly.</p>
                        
                        {status.msg && (
                            <div className={`mb-8 p-4 rounded-2xl flex items-center gap-3 text-xs font-bold ${status.type === 'success' ? 'bg-emerald-50 text-emerald-800 border border-emerald-200' : 'bg-red-50 text-red-800 border border-red-200'}`}>
